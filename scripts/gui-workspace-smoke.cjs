...
async function runSmoke() {
  ...
  if (!closePayload.closed || closePayload.browserExited !== true || closePayload.agentSessionClosed !== true) {
    fail("workspace close did not confirm browser and agent-session cleanup");
  }
